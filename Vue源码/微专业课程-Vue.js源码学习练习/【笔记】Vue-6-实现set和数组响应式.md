...
vue2.0 中不能直接监听对象中新增属性的变化，如果需要监听，需要通过 [Vue.set( target, propertyName/index, value )](https://cn.vuejs.org/v2/api/#Vue-set "Vue.set( target, propertyName/index, value )方法添加
